...
class mainApp(Tk):
    ...
    def createLayout(self):
        ...
        self.rb1 = ttk.Radiobutton(self, text="Farenheit", variable=self.tipoUnidad, value="F", command=self.selected).place(x=10, y=75)
        self.rb2 = ttk.Radiobutton(self, text="Celcius", variable=self.tipoUnidad, value="C",command=self.selected).place(x=10, y=95)
